                ...
                <div class="layui-card-body" style="width: 600px; float: left;">
                    ...
                    <form class="layui-form layui-col-space5"  style="margin: -0.5px;">
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-inline layui-show-xs-block">
                                <input type="date" autocomplete="off"  class="layui-input" name="registrationtime" id="registrationtime">
                            </div>
                        </div>
                        <div class="layui-inline layui-show-xs-block">
...
<script>
    ...
    //车辆
    function carName(data) {
        console.log(data);
        var select = "";
        select += ' <select type="text" placeholder="车辆" id="" name="carname" class="carname">'
        return select;
        //车辆
        createSelect(".carname", "http://localhost:8070/DivideController/Selectcar");
    }
