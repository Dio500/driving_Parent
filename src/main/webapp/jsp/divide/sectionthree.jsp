                        ...
                        <div class="col-12">
                            <form class="layui-form layui-col-space5">
                                ...
                                <div class="layui-inline layui-show-xs-block">
                                    ...
                                    <button type="button"  onclick=""  class="layui-btn layui-btn-normal" onclick="">导出
                        ...
                        <div class="layui-input-inline layui-show-xs-block">
                            ...
                            <div class="layui-input-inline layui-show-xs-block" style="width: 130px;">
                                <select id="gender">
                                    ...
                                    <option value="true">c1</option>
                                    <option value="false">c2</option>
                                </select>
                            </div>
                        </div>
                        <div class="layui-input-inline layui-show-xs-block">
...
<script>
    ...
    var tbstudent , tbcoach ,tbcar;//学生表
    ...
    $(function(){
        ...
        layui.use(['layer','laydate','table','form'], function(){
            ...
            tbcoach = layuiTable.render({
                elem: '#tbcoach',
                url: 'http://localhost:8070/HealthController/SelectYface',
                cols: [[
                    { type: 'checkbox' },
                    // { type: 'numbers', title: '序号', width: 50, unresize: true },
                    { field: 'studentid', title: '学员ID', hide: true },
                    { field: 'name', title: '车辆', width: 100, align: 'center', unresize: true },
                    { field: 'sex', title: '教练', width: 60, align: 'center' },
                    { field: 'modelname', title: '准教车型', width: 165, align: 'center' },
                    { field: 'phoneone', title: '在车数', width: 140, align: 'center' },
                ]],
                page: {
                    limit: 5,//每页显示的条数
                    limits: [5, 10, 15, 20, 25, 30, 35, 40, 45, 50],//每页条数的选择项
        ...
        layui.use(['layer','laydate','table','form'], function(){
            ...
            tbcar = layuiTable.render({
                ...
                cols: [[
                    ...
                    { field: 'studentid', title: '学员ID', hide: true },
                    { field: 'name', title: '姓名', width: 100, align: 'center', unresize: true },
                    { field: 'sex', title: '科目', width: 60, align: 'center' },
