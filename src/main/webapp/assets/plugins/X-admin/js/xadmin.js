;!function (win) {
  ...
  Xadmin.prototype.end = function() {
	...
	Xadmin.prototype.add_tab = function (title,urls,is_refresh) {
        var url = "http://localhost:8070/LoginServlet/RoleMouble?JSPurl="+urls;
  ...
  Xadmin.prototype.del_tab = function (id) {
	...
	Xadmin.prototype.add_lay_tab = function(title,url,id) {
        //src="http://localhost:8070/LoginServlet/RoleMouble?JSPurl='+url+'"
        /*$.post("http://localhost:8070/LoginServlet/selectSession",function (data) {
